<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\ma_xue_yuan_category\index.html";i:1537415123;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="box box-info">
                ...
                <div class="panel-body mb0">
                    <div class="navbar navbar-default mb0">
                        <form class="navbar-form form-inline" method="post" action="">
                            <a href='<?php echo url("admin/ma_xue_yuan_category/add"); ?>' class="btn btn-info pull-right">添加栏目</a>
                            <!-- <if condition="$moduleid neq 3"></if> -->
                        </form>
                    </div>
                </div>
                <!-- table -->
                <div class="box-body">
                    <div class="table-responsive">
                        <form id="myform" name="myform" action='<?php echo url("Admin/team_category/listorder"); ?>' method="post">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- <a href="<?php echo url('admin/team_category/add',['pid'=>$vo['id']]); ?>" class="btn btn-warning">添加子栏目</a> -->
                                        <a href="<?php echo url('admin/team_category/edit',['id'=>$vo['id']]); ?>" class="btn btn-primary">编辑</a>
                                        <a href="<?php echo url('admin/team_category/delete',['id'=>$vo['id']]); ?>" onclick="return confirm('确定删除吗?')" class="btn btn-danger btn-mini ajax-delete">删除</a>
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
