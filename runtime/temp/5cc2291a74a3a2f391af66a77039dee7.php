<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\article\index.html";i:1534835845;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="box box-info">
                        ...
                        <form class="navbar-form form-inline" method="post" action="">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="input-sm" placeholder="标题" value="<?php echo $keyword; ?>" name="keyword" />
                                </div>
                            ...
                            <a href='<?php echo url("Admin/Article/add"); ?>' class="btn btn-info pull-right">添加文章</a>
                        </form>
                    </div>
                </div>
                <!-- table -->
                <div class="box-body">
                    <div class="table-responsive">
                        <form id="myform" name="myform" action='<?php echo url("Admin/Article/listorder"); ?>' method="post">
                        <table class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>编号/ID</th>
                                    <th>标题</th>
                                    <eq name="mname" value="Picture"><th>缩略图</th></eq>
                                    <th>是否显示</th>
                                    <th>发布时间</th>
                                    <th>操作</th>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td width="40">
                                        <input name="sort[<?php echo $vo['id']; ?>]" type="text" size="3" value="<?php echo $vo['sort']; ?>" class="text-center">
                                    </td>
                                    <td><?php echo $vo['id']; ?></td>
                                    <td><a href='<?php echo url("Admin/Article/edit",["id"=>$vo["id"]]); ?>'><?php echo $vo['title']; ?></td>
                                    <td><?php if($vo['thumb'] != null): ?><img src="/<?php echo $vo['thumb']; ?>" width="50px" /><?php endif; ?></td>
                                    <td>
                                      <?php if($vo['isdel'] == '0'): ?>
                                    ...
                                    <td>
                                        <a href='<?php echo url("Admin/Article/edit",["id"=>$vo["id"]]); ?>' class="btn btn-xs btn-primary">编辑</a>
                                        <a href='<?php echo url("Admin/Article/delete",["id"=>$vo["id"]]); ?>' onclick="return confirm('确定删除吗?')" class="btn btn-xs btn-danger ajax-delete">删除</a>
                                    </td>
