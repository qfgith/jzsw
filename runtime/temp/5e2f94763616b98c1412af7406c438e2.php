<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\team\add.html";i:1535535960;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php echo $info1['ueditor']; ?>
                    <form id="form1" method="post" action="<?php echo url('admin/Team/save'); ?>">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered">
                                    <tr>
                                        <td id="box">上级栏目</td>
                                        <td >
                                             <select name="cid" lay-verify="required" class='col-sm-4 form-control select2'>
                                                ...
                                                <option value="<?php echo $vo['id']; ?>" <?php if($vo['child'] == 1): ?>disabled="disabled"<?php endif; ?> ><?php if($vo['level'] != '1'): ?>|<?php for($i=1;$i<$vo['level'];$i++){echo ' ----';} endif; ?> <?php echo $vo['name']; ?></option>
                                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                    ...
                                    <tr>
                                        <td id="box">标题</td>
                                        <td >
                                            <input type="text" name="title" value="" required  lay-verify="required" placeholder="标题" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="box">英文名</td>
                                        <td >
                                            <input type="text" name="title1" value="" required  lay-verify="required" placeholder="英文名" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="box">职位</td>
                                        <td >
                                            <input type="text" name="title2" value="" required  lay-verify="required" placeholder="职位" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="box">邮箱</td>
                                        <td >
                                            <input type="text" name="email" value="" required  lay-verify="required" placeholder="邮箱" class="form-control">
                                        </td>
                                    </tr>
                                    <!-- <tr>
                                        <td id="box"> 略缩图 </td>
                                    ...
                                    <tr>
                                        <td id="box"> 推荐到首页 </td>
                                        <td >
                                            <input type="radio" class='iccontrol' name="is_pos" value="0" title="否" checked="checked"><span class="ml10 mr30">否</span>
                                            <input type="radio" class='iccontrol' name="is_pos" value="1" title="是"><span class="ml10 mr30">是</span>
                                        </td>
                                    </tr>
