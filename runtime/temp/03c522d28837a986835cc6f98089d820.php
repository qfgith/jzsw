<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\slide\edit.html";i:1534827873;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-info info_box">
                ...
                <div class="box-body">
                    <!--表单数据-->
                    <form method="post" id="adminHandle" action="<?php echo url('admin/slide/edit'); ?>">
                    <?php if($info['id'] != 0): ?><input type="hidden" name="id" value="<?php echo $info['id']; ?>"><?php endif; ?>
                    <div class="tab-content col-md-12">                       
                        <div class="tab-pane active" id="pengyouquan">    
                            <table class="table table-bordered">
                                
                                <tr>
                                    <td class="col-sm-2">所属分类：</td>
                                    <td class="col-sm-10">
                                        <select name="cid" lay-verify="required" class="form-control w400">
                                            <?php if(is_array($slide_category_list) || $slide_category_list instanceof \think\Collection): if( count($slide_category_list)==0 ) : echo "" ;else: foreach($slide_category_list as $key=>$vo): ?>
                                            <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $info['cid']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                                            <?php endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="col-sm-10">
                                        <input type="text" class="form-control w400" name="name" value="<?php echo $info['name']; ?>" >
                                    </td>
                                </tr>
                                <tr>
                                    <td>图片：<?php if($info['cid']==7 || $info['cid']==8): ?>(110*110)<?php endif; ?></td>
                                    <td>
                                        <input type="text" name="image" value="<?php echo $info['image']; ?>" size="50" class="layui-input input-text">
                                        <button type="button" class="btn btn-primary layui_upimage">上传图片</button>
                                        <?php if(!(empty($info['image']) || ($info['image'] instanceof \think\Collection && $info['image']->isEmpty()))): ?><img src="/<?php echo $info['image']; ?>" class="th1_img img"><?php endif; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>链接：</td>
                                    <td>
                                        <input type="text" class="form-control w400" name="link" value="<?php echo $info['link']; ?>" >
                                    </td>
                                </tr>
                                <tr>
                                    <td> 状态 </td>
                                    <td >
                                        <input type="radio" class='iccontrol' name="status" value="1" <?php if($info['status'] == 1): ?>checked<?php endif; ?>><span class="ml10 mr30">显示</span>
                                        <input type="radio" class='iccontrol' name="status" value="0" <?php if($info['status'] == 0): ?>checked<?php endif; ?>><span class="ml10 mr30">隐藏</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
