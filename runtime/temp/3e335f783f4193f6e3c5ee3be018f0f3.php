<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\ma_xue_yuan_category\add.html";i:1537416885;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/ma_xue_yuan_category/save'); ?>">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered">
                                    ...
                                    <!-- <tr>
                                        <td id="box">类型</td>
                                        <td >
                                           <select name="type" lay-verify="required" class='col-sm-4 form-control select2'>
