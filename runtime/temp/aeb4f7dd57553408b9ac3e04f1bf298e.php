<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\team_category\index.html";i:1535439487;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                ...
                <div class="panel-body mb0">
                    <div class="navbar navbar-default mb0">
                        <form class="navbar-form form-inline" method="post" action="">
                            ...
                            <!-- <if condition="$moduleid neq 3"><a href='<?php echo url("admin/team_category/add"); ?>' class="btn btn-info pull-right">添加栏目</a></if> -->
                        </form>
                    </div>
                </div>
                <!-- table -->
