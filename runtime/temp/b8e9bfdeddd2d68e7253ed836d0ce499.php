<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\menu\add.html";i:1533016246;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="col-md-12">
            <div class="box box-info info_box">
                <div class="box-header with-border">
                    <h3 class="box-title">添加后台菜单</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <!--表单数据-->
                    <form method="post" id="adminHandle" action="<?php echo url('admin/menu/save'); ?>">
                        ...
                        <div class="tab-pane active" id="tab_tongyong">                           
                            <table class="table table-bordered">
                                <tr>
                                    ...
                                    <td class="col-sm-8">
                                        <input type="text" name="title" class="form-control" placeholder="菜单名称">
                                    </td>
                                </tr>  
                                <tr>
                                    <td>所属菜单：</td>
                                ...
                                <tr>
                                    <td>菜单图标：</td>
                                    <td>
                                        <input type="text" class="form-control" name="icon" value="fa fa-circle-o" placeholder="fa fa-edit">
                                    </td>
                                </tr>
                                <tr>
                                    <td>是否显示：</td>
                                    <td>
                                        <input type="radio" class="iccontrol rr" name="status" value="1" checked ><span class="ml10 mr30">显示</span>
                                        <input type="radio" class="iccontrol rr" name="status" value="0"><span class="ml10 mr30">隐藏</span>
                                    </td>
                                </tr>
                                <tr>
                                    <td>排序：</td>
