<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\login\index.html";i:1533102846;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
        ...
        <title>平台管理后台-<?php echo $webset['site_name']; ?></title>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="<?php echo $cdomain; ?>__PTSTA__/plugins/iCheck/square/blue.css">
        
    </head>
    <body class="hold-transition login-page">
        <div class="abdiv">
            <h3><b><?php echo $webset['site_name']; ?></b></h3>
                ...
                <form method="post" action="<?php echo url('admin/Login/login'); ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4">
                            ...
                            <button class="btn btn-primary btn-block btn-flat" lay-submit lay-filter="*" >登录</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
