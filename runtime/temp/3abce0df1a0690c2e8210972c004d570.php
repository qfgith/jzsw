<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:79:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\slide_category\index.html";i:1534835186;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="box box-info">
                ...
                <div class="panel-body mb0">
                    <div class="navbar navbar-default mb0">
                        <form class="navbar-form form-inline" method="post" action="">
                            ...
                            <!-- <a href='<?php echo url("Admin/SlideCategory/add"); ?>' class="btn btn-info pull-right">添加幻灯片</a> -->
                        </form>
                    </div>
                </div>
                <!-- table -->
                <div class="box-body">
                    <div class="table-responsive">
                        <form id="myform" name="myform" action='<?php echo url("Admin/SlideCategory/listorder"); ?>' method="post">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <?php if(is_array($slide_category_list) || $slide_category_list instanceof \think\Collection): $i = 0; $__LIST__ = $slide_category_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    
                                    <td><?php echo $vo['id']; ?></td>
                                    <td><?php echo $vo['name']; ?></td>
                                    <td>
                                        <a href='<?php echo url("Admin/Slide/index",["cate_id"=>$vo["id"]]); ?>' class="btn btn-xs btn-primary">图片管理</a>
                                    </td>
                                    <td>
                                        <a href='<?php echo url("Admin/SlideCategory/edit",["id"=>$vo["id"]]); ?>' class="btn btn-xs btn-primary">编辑</a>
                                        <a href='<?php echo url("Admin/SlideCategory/delete",["id"=>$vo["id"]]); ?>' onclick="return confirm('确定删除吗?')" lay-filter="*" class="btn btn-xs btn-danger">删除</a>
                                    </td>
