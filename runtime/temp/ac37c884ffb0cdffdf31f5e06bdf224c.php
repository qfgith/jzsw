<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\cases\add.html";i:1535530665;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/Cases/save'); ?>">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td id="box">案件名称</td>
                                        <td >
                                            <input type="text" name="title" value="" required  lay-verify="required" placeholder="案件名称" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="box">委托方</td>
                                        <td >
                                            <input type="text" name="title1" value="" required  lay-verify="required" placeholder="委托方" class="form-control">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td id="box">发布人</td>
                                        <td >
                                            <input type="text" name="author" value="" required  lay-verify="required" placeholder="发布人" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="box"> 状态 </td>
