<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\page_about_category\edit.html";i:1535427749;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/PageAboutCategory/update',['id'=>$category['id']]); ?>">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td id="box">栏目名称</td>
                                        <td >
                                            <input type="text" name="name" value="<?php echo $category['name']; ?>" required  lay-verify="required" placeholder="请输入栏目名称" class="form-control">
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td id="box">别名</td>
                                        <td >
                                            <input type="text" name="alias" value="<?php echo $category['alias']; ?>"  placeholder="别名" class="form-control">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="box"> banner图 </td>
                                        <td >
                                            <input type="text" name="thumb" id="img" size="50" value="<?php echo $category['thumb']; ?>" class="layui-input input-text">
                                            <button type="button" class="btn btn-primary layui_upimage">上传图片</button>
                                            <?php if(!(empty($category['thumb']) || ($category['thumb'] instanceof \think\Collection && $category['thumb']->isEmpty()))): ?><img src="/<?php echo $category['thumb']; ?>" class="th1_img imgb"><?php endif; ?>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td id="box">描述</td>
                                        <td >
                                            <textarea name='introduction' class="form-control" placeholder="描述" rows='5'><?php echo $category['introduction']; ?></textarea>
                                        </td>
                                    </tr>
