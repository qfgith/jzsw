<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\team_category\add.html";i:1535439191;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/team_category/save'); ?>">
