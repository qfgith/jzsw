<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\cases\index.html";i:1535455643;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="box box-info">
                ...
                <div class="panel-body mb0">
                    <div class="navbar navbar-default mb0">
                        <form class="navbar-form form-inline" method="post" action="">
                            ...
                            <a href='<?php echo url("Admin/Cases/add"); ?>' class="btn btn-info pull-right">添加案例</a>
                        </form>
                    </div>
                </div>
                <!-- table -->
                <div class="box-body">
                    <div class="table-responsive">
                        <form id="myform" name="myform" action='<?php echo url("Admin/Cases/listorder"); ?>' method="post">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href='<?php echo url("Admin/Cases/edit",["id"=>$vo["id"]]); ?>'><?php echo $vo['title']; ?></td>
                                    ...
                                    <td>
                                        <a href='<?php echo url("admin/Cases/edit",["id"=>$vo["id"]]); ?>' class="btn btn-xs btn-primary">编辑</a>
                                        <a href='<?php echo url("Admin/Cases/delete",["id"=>$vo["id"]]); ?>' onclick="return confirm('确定删除吗?')" lay-filter="*" class="btn btn-xs btn-danger">删除</a>
                                    </td>
