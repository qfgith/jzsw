<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\page_about_category\edit_page.html";i:1535427677;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="info_box">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <form id="form1" method="post" action="<?php echo url('admin/PageAboutCategory/update_page'); ?>">
                            ...
                            <div class="panel-body">
                                <table class="table table-bordered">
                                    <tr>
                                        <td id="box">标题</td>
                                        <td >
                                            <input type="text" name="title" value="<?php if($article['title']==''): ?><?php echo $article['name']; else: ?><?php echo $article['title']; endif; ?>" required  lay-verify="required" placeholder="标题" class="form-control">
                                        </td>
                                    </tr>
                                    ...
                                    <!-- <tr>
                                        <td id="box"> 描述 </td>
                                        <td >
                                            <textarea class="form-control" name="introduction" rows="3"><?php echo $article['introduction']; ?></textarea>
                                        </td>
                                    </tr> -->
