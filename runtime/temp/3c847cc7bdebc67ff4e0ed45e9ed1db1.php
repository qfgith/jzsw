<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\page_about_category\index.html";i:1535427399;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="box box-info">
                ...
                <div class="panel-body mb0">
                    <div class="navbar navbar-default mb0">
                        <form class="navbar-form form-inline" method="post" action="">
                            ...
                            <if condition="$moduleid neq 3"><a href='<?php echo url("admin/page_about_category/add"); ?>' class="btn btn-info pull-right">添加栏目</a></if>
                        </form>
                    </div>
                </div>
                <!-- table -->
                <div class="box-body">
                    <div class="table-responsive">
                        <form id="myform" name="myform" action='<?php echo url("Admin/page_about_category/listorder"); ?>' method="post">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- <a href="<?php echo url('admin/page_about_category/add',['pid'=>$vo['id']]); ?>" class="btn btn-warning">添加子栏目</a> -->
                                        <a href="<?php echo url('admin/page_about_category/edit',['id'=>$vo['id']]); ?>" class="btn btn-primary">编辑</a>
                                        <a href="<?php echo url('admin/page_about_category/delete',['id'=>$vo['id']]); ?>" onclick="return delfun(this)" class="btn btn-danger btn-mini">删除</a>
                                    </td>
                                    <td><a href="<?php echo url('admin/PageAboutCategory/edit_page',['id'=>$vo['id']]); ?>" class="btn btn-primary">编辑内容</a></td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
