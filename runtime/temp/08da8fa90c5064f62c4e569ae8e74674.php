<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:70:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\slide\index.html";i:1534932058;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
                ...
                <div class="panel-body mb0">
                    <div class="navbar navbar-default mb0">
                        <div class="navbar-form form-inline">
                            <?php if($cate_id!=5 && $cate_id !=7 && $cate_id !=8 && $cate_id !=9): ?><a href="<?php echo url('admin/slide/add',['cid'=>$cate_id]); ?>" class="btn btn-info">添加图片</a><?php endif; ?>
                        </div>
                    </div>
                </div>
                <!-- /.box-header -->
                        ...
                        <table class="table no-margin">
                            ...
                            <tbody>
                                ...
                                <tr role="row">
                                    ...
                                    <td><?php if(!(empty($vo['image']) || ($vo['image'] instanceof \think\Collection && $vo['image']->isEmpty()))): ?><img src="<?php echo $cdomain; ?><?php echo $vo['image']; ?>" class="mw100h50"><?php endif; ?></td>
                                    <td><?php if($vo['status'] == '1'): ?><label class="btn btn-sm btn-success">显示<?php else: ?><label class="btn btn-sm btn-danger">隐藏<?php endif; ?></label></td>
                                    <td>
                                        <a href="<?php echo url('admin/slide/edit',['id'=>$vo['id']]); ?>" class="btn btn-sm btn-primary">编辑</a>
                                         <?php if($cate_id !=9&&$cate_id !=5): ?><a href='<?php echo url("admin/slide/delete",["id"=>$vo["id"]]); ?>' onclick="return confirm('确定删除吗?')" lay-filter="*" class="btn btn-xs btn-danger">删除</a><?php endif; ?>
                                        <!-- <?php if($cate_id !=9&&$cate_id !=5): ?><a class="btn btn-sm btn-danger ajax-action" onclick="return confirm('确定删除吗?')" data-action="<?php echo url('admin/slide/delete',['id'=>$vo['id']]); ?>">删除</a><?php endif; ?> -->
                                    </td>
                                </tr>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </tbody>
