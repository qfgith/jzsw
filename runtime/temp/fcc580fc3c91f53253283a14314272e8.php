<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\menu\index.html";i:1533102846;s:63:"D:\wokerplace\juzhangshengwu\public/../app/admin\view\base.html";i:1537326424;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <div class="box box-info">
                <div class="box-header with-border">
                    ...
                    <div class="form-group pull-right">
                        <a href="<?php echo url('admin/menu/add'); ?>" class="btn btn-default">添加菜单</a>
                    </div>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="table-responsive">
                        <form id="myform" name="myform" action="<?php echo url('admin/menu/listorder'); ?>" method="post">
                            <table class="table no-margin">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $vo['status']==1 ? '<label class="btn btn-sm btn-success">显示</label>' : '<label class="btn btn-sm btn-danger">隐藏</label>'; ?></td>
                                        <td>
                                            <a href="<?php echo url('admin/menu/add',['pid'=>$vo['id']]); ?>" class="btn btn-sm btn-warning">添加子菜单</a>
                                            <a href="<?php echo url('admin/menu/edit',['id'=>$vo['id']]); ?>" class="btn btn-sm btn-primary">编辑</a>
                                            <a href="<?php echo url('admin/menu/delete',['id'=>$vo['id']]); ?>" onclick="return confirm('确定删除吗?')" class="btn btn-sm btn-danger">删除</a>
                                        </td>
                                    </tr>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                    <tr>
